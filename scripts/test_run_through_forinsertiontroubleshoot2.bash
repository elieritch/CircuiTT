...
mkdir -p /groups/wyattgrp/eritch/projects/gene_panel_pipeline/test_data_output_forins;
...
outputdir="/groups/wyattgrp/eritch/projects/gene_panel_pipeline/test_data_output_forins/${name_tumor}";
