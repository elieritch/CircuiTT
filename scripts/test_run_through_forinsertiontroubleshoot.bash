...
mkdir -p /groups/wyattgrp/eritch/projects/gene_panel_pipeline/test_data_output;
...
outputdir="/groups/wyattgrp/eritch/projects/gene_panel_pipeline/test_data_output/${name_tumor}";
