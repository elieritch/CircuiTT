...
parser.add_argument("-som_ano", help="Path to somatic anno file (SNV or INDEL)", dest="somano", type=str, required=True)
...
args.somano = os.path.expanduser(args.somano)
...
def main():
	...
	df = pd.read_csv(args.somano, sep='\t', low_memory=False)
